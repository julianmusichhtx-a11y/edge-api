...
PROP_STAT_MAP = {
    ...
    "three points made": "three_pointers_made",
    ...
    # Soccer
    "shots": "shots", "shots attempted": "shots", "shots on target": "shots_on_target",
    "shots on goal": "shots_on_target",
    "tackles": "tackles", "passes": "passes",
    "passes attempted": "passes",
    "goalkeeper saves": "goalkeeper_saves", "saves": "goalkeeper_saves",
    "fouls committed": "fouls_committed", "fouls drawn": "fouls_drawn",
    "cards": "yellow_cards", "yellow cards": "yellow_cards",
    ...
    "games won": "games_won", "total sets": "total_sets",
    "sets won": "sets_won", "match winner": "match_winner",
    "set winner": "set_winner", "break points won": "break_points_won",
